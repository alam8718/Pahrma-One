  ...
  return (
    <PageWrapper>
      ...
      <div className="max-w-[445px]  min-h-[355px]  rounded-[4px] border border-gray-400/50 font-poppins">
        ...
        {/* rest */}
        <div className="w-full h-[calc(100%-53px)] overflow-y-auto flex items-center gap-5 pl-8 py-5 flex-col overflow-x-auto">
          {pages.map((page, index) => (
            <div key={index + 1} className="w-full flex gap-4 ">
